...
public class OntoUMLParserProvider extends AbstractProvider implements
	 ...
	 * @generated
	 */
	private IParser datatypeAssociationName_6025Parser;

	/**
	 * @generated
	 */
	private IParser getDatatypeAssociationName_6025Parser() {
		if (datatypeAssociationName_6025Parser == null) {
			datatypeAssociationName_6025Parser = createDatatypeAssociationName_6025Parser();
		}
		return datatypeAssociationName_6025Parser;
	}

	/**
	 * @generated
	 */
	protected IParser createDatatypeAssociationName_6025Parser() {
		EAttribute[] features = new EAttribute[] { OntoUML.OntoUMLPackage.eINSTANCE
				.getNamedElement_Name(), };
		OntoUML.diagram.parsers.MessageFormatParser parser = new OntoUML.diagram.parsers.MessageFormatParser(
				features);
	...
	protected IParser getParser(int visualID) {
		...
		case OntoUML.diagram.edit.parts.DatatypeAssociationName2EditPart.VISUAL_ID:
			return getDatatypeAssociationName_6025Parser();
