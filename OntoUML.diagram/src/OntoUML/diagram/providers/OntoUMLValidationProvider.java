 ...
 * @generated
 */
public class OntoUMLValidationProvider extends AbstractContributionItemProvider {
	...
	protected IAction createAction(String actionId,
		...
		if (OntoUML.diagram.part.ValidateAction.VALIDATE_ACTION_KEY
				.equals(actionId)) {
			return new OntoUML.diagram.part.ValidateAction(partDescriptor);
		}
