 ...
 * @generated
 */
public class ModeViewFactory extends AbstractShapeViewFactory {
	...
	protected void decorateView(View containerView, View view,
		...
		if (semanticHint == null) {
			semanticHint = OntoUML.diagram.part.OntoUMLVisualIDRegistry
					.getType(OntoUML.diagram.edit.parts.ModeEditPart.VISUAL_ID);
		...
		getViewService()
				.createNode(
						...
						view,
						OntoUML.diagram.part.OntoUMLVisualIDRegistry
								.getType(OntoUML.diagram.edit.parts.ModeNameEditPart.VISUAL_ID),
						ViewUtil.APPEND, true, getPreferencesHint());
		getViewService()
				.createNode(
						eObjectAdapter,
