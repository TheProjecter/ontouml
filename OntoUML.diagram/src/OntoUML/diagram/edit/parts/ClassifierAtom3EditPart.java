 ...
 * @generated
 */
public class ClassifierAtom3EditPart extends ConnectionNodeEditPart implements
		ITreeBranchEditPart {
	 ...
	 * @generated
	 */
	public ClassifierAtom3EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new OntoUML.diagram.edit.policies.ClassifierAtom3ItemSemanticEditPolicy());
	}
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof OntoUML.diagram.edit.parts.ClassifierAtomNameEditPart) {
			((OntoUML.diagram.edit.parts.ClassifierAtomNameEditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureConclusionVar1LabelFigure());
			return true;
		}
		if (childEditPart instanceof OntoUML.diagram.edit.parts.ClassifierAtomName2EditPart) {
			((OntoUML.diagram.edit.parts.ClassifierAtomName2EditPart) childEditPart)
					.setLabel(getPrimaryShape()
