...
public class DatatypeAssociationEditPart extends ConnectionNodeEditPart
		...
		if (childEditPart instanceof OntoUML.diagram.edit.parts.DatatypeAssociationNameEditPart) {
			((OntoUML.diagram.edit.parts.DatatypeAssociationNameEditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureDatatypeAssociationLabelFigure());
			return true;
		}
		if (childEditPart instanceof OntoUML.diagram.edit.parts.DatatypeAssociationName2EditPart) {
			((OntoUML.diagram.edit.parts.DatatypeAssociationName2EditPart) childEditPart)
					.setLabel(getPrimaryShape()
	...
	public class DatatypeAssociationFigure extends PolylineConnectionEx {
		 ...
		 * @generated
		 */
		private WrappingLabel fFigureDatatypeAssociationLabelFigure;
		/**
		 * @generated
		 */
		...
		private void createContents() {
			...
			fFigureDatatypeAssociationLabelFigure = new WrappingLabel();
			fFigureDatatypeAssociationLabelFigure
					.setText("«datatypeAssociation»");

			this.add(fFigureDatatypeAssociationLabelFigure);
		...
		private void createContents(
			...
			// Puts the Property that points to the Datatype in the AttributeCompartment of the Element.
			/*for (int i = 0; i < d.getAssociationEnd().size(); ++i)
				if (d.getAssociationEnd().get(i).getAssociationEndPositionAux() == 2) {
					d.getAssociationEnd().get(i).setName("Name");
					for (int j = 0; j < d.getAssociationEnd().size(); ++j)
						if (d.getAssociationEnd().get(j)
								.getAssociationEndPositionAux() == 1)
							d.getAssociationEnd().get(i).setOwner(
									d.getAssociationEnd().get(j).getEndType());
			}*/
		}
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureDatatypeAssociationLabelFigure() {
			return fFigureDatatypeAssociationLabelFigure;
		}
