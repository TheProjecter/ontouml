 ...
 * @generated
 */
public class ClassifierAtomName2EditPart extends LabelEditPart implements
		ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				OntoUML.diagram.part.OntoUMLVisualIDRegistry
						.getType(OntoUML.diagram.edit.parts.ClassifierAtomName2EditPart.VISUAL_ID),
				new Point(0, 60));
	}
	 ...
	 * @generated
	 */
	public ClassifierAtomName2EditPart(View view) {
		super(view);
	}
