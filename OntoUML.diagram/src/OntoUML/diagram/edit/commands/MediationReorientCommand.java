 ...
 * @generated
 */
public class MediationReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public MediationReorientCommand(ReorientRelationshipRequest request) {
	...
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof OntoUML.Mediation) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		...
		return OntoUML.diagram.edit.policies.OntoUMLBaseItemSemanticEditPolicy.LinkConstraints
				.canExistMediation_4008(container, getNewSource(), target);
	}
	...
	protected boolean canReorientTarget() {
		...
		OntoUML.Container container = (OntoUML.Container) getLink()
				.eContainer();
		return OntoUML.diagram.edit.policies.OntoUMLBaseItemSemanticEditPolicy.LinkConstraints
				.canExistMediation_4008(container, source, getNewTarget());
	}
	 ...
	 * @generated
	 */
	protected OntoUML.Mediation getLink() {
		return (OntoUML.Mediation) getElementToEdit();
	}
