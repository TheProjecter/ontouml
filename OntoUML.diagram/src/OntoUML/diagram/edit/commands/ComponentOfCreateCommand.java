 ...
 * @generated
 */
public class ComponentOfCreateCommand extends CreateElementCommand {
	 ...
	 * @generated
	 */
	public ComponentOfCreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		return OntoUML.diagram.edit.policies.OntoUMLBaseItemSemanticEditPolicy.LinkConstraints
				.canCreateComponentOf_4002(getContainer(), getSource(),
						getTarget());
	}
	...
	protected EObject doDefaultElementCreation() {
		OntoUML.componentOf newElement = OntoUML.OntoUMLFactory.eINSTANCE
				.createcomponentOf();
		...
		OntoUML.diagram.providers.OntoUMLElementTypes
				.init_ComponentOf_4002(newElement);
		return newElement;
	}
