 ...
 * @generated
 */
public class BinaryAssociationAtomReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public BinaryAssociationAtomReorientCommand(
	...
	protected boolean canReorientSource() {
		...
		return OntoUML.diagram.edit.policies.OntoUMLBaseItemSemanticEditPolicy.LinkConstraints
				.canExistBinaryAssociationAtom_4013(container, getNewSource(),
						target);
	}
	...
	protected boolean canReorientTarget() {
		...
		OntoUML.Container container = (OntoUML.Container) getLink()
				.eContainer();
		return OntoUML.diagram.edit.policies.OntoUMLBaseItemSemanticEditPolicy.LinkConstraints
				.canExistBinaryAssociationAtom_4013(container, source,
						getNewTarget());
	}
