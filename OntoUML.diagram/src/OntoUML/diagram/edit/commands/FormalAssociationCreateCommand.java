 ...
 * @generated
 */
public class FormalAssociationCreateCommand extends CreateElementCommand {
	 ...
	 * @generated
	 */
	public FormalAssociationCreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		return OntoUML.diagram.edit.policies.OntoUMLBaseItemSemanticEditPolicy.LinkConstraints
				.canCreateFormalAssociation_4005(getContainer(), getSource(),
						getTarget());
	}
	...
	protected EObject doDefaultElementCreation() {
		OntoUML.FormalAssociation newElement = OntoUML.OntoUMLFactory.eINSTANCE
				.createFormalAssociation();
		...
		OntoUML.diagram.providers.OntoUMLElementTypes
				.init_FormalAssociation_4005(newElement);
		return newElement;
	}
