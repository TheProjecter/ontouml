 ...
 * @generated
 */
public class SubCollectionOfCreateCommand extends CreateElementCommand {
	 ...
	 * @generated
	 */
	public SubCollectionOfCreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		return OntoUML.diagram.edit.policies.OntoUMLBaseItemSemanticEditPolicy.LinkConstraints
				.canCreateSubCollectionOf_4010(getContainer(), getSource(),
						getTarget());
	}
	...
	protected EObject doDefaultElementCreation() {
		OntoUML.subCollectionOf newElement = OntoUML.OntoUMLFactory.eINSTANCE
				.createsubCollectionOf();
		...
		OntoUML.diagram.providers.OntoUMLElementTypes
				.init_SubCollectionOf_4010(newElement);
		return newElement;
	}
