 ...
 * @generated
 */
public class MemberOfReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public MemberOfReorientCommand(ReorientRelationshipRequest request) {
	...
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof OntoUML.memberOf) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		...
		return OntoUML.diagram.edit.policies.OntoUMLBaseItemSemanticEditPolicy.LinkConstraints
				.canExistMemberOf_4009(container, getNewSource(), target);
	}
	...
	protected boolean canReorientTarget() {
		...
		OntoUML.Container container = (OntoUML.Container) getLink()
				.eContainer();
		return OntoUML.diagram.edit.policies.OntoUMLBaseItemSemanticEditPolicy.LinkConstraints
				.canExistMemberOf_4009(container, source, getNewTarget());
	}
	 ...
	 * @generated
	 */
	protected OntoUML.memberOf getLink() {
		return (OntoUML.memberOf) getElementToEdit();
	}
