 ...
 * <ul>
 *   <li>{@link UMLPlus.impl.GeneralizationSetImpl#isIsCovering <em>Is Covering</em>}</li>
 *   <li>{@link UMLPlus.impl.GeneralizationSetImpl#isIsDisjoint <em>Is Disjoint</em>}</li>
 *   <li>{@link UMLPlus.impl.GeneralizationSetImpl#getSemnome <em>Semnome</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class GeneralizationSetImpl extends NamedElementImpl implements GeneralizationSet {
	...
	protected EClass eStaticClass() {
		return UMLPlusPackage.Literals.GENERALIZATION_SET;
	}
	...
	public void setIsCovering(boolean newIsCovering) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UMLPlusPackage.GENERALIZATION_SET__IS_COVERING, oldIsCovering, isCovering));
	}
	...
	public void setIsDisjoint(boolean newIsDisjoint) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UMLPlusPackage.GENERALIZATION_SET__IS_DISJOINT, oldIsDisjoint, isDisjoint));
	}
	...
	public EList<Generalization> getSemnome() {
		if (semnome == null) {
			semnome = new EObjectWithInverseResolvingEList.ManyInverse<Generalization>(Generalization.class, this, UMLPlusPackage.GENERALIZATION_SET__SEMNOME, UMLPlusPackage.GENERALIZATION__SEMNOME);
		}
		return semnome;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case UMLPlusPackage.GENERALIZATION_SET__SEMNOME:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case UMLPlusPackage.GENERALIZATION_SET__IS_COVERING:
				return isIsCovering() ? Boolean.TRUE : Boolean.FALSE;
			case UMLPlusPackage.GENERALIZATION_SET__IS_DISJOINT:
