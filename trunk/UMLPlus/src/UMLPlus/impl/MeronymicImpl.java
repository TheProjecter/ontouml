 ...
 * <ul>
 *   <li>{@link UMLPlus.impl.MeronymicImpl#isIsShareable <em>Is Shareable</em>}</li>
 *   <li>{@link UMLPlus.impl.MeronymicImpl#isIsEssential <em>Is Essential</em>}</li>
 *   <li>{@link UMLPlus.impl.MeronymicImpl#isIsInseparable <em>Is Inseparable</em>}</li>
 *   <li>{@link UMLPlus.impl.MeronymicImpl#isIsImmutablePart <em>Is Immutable Part</em>}</li>
 *   <li>{@link UMLPlus.impl.MeronymicImpl#isIsImmutableWhole <em>Is Immutable Whole</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class MeronymicImpl extends DirectedBinaryRelationshipImpl implements Meronymic {
	...
	protected EClass eStaticClass() {
		return UMLPlusPackage.Literals.MERONYMIC;
	}
	...
	public void setIsShareable(boolean newIsShareable) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UMLPlusPackage.MERONYMIC__IS_SHAREABLE, oldIsShareable, isShareable));
	}
	...
	public void setIsEssential(boolean newIsEssential) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UMLPlusPackage.MERONYMIC__IS_ESSENTIAL, oldIsEssential, isEssential));
	}
	...
	public void setIsInseparable(boolean newIsInseparable) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UMLPlusPackage.MERONYMIC__IS_INSEPARABLE, oldIsInseparable, isInseparable));
	}
	...
	public void setIsImmutablePart(boolean newIsImmutablePart) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UMLPlusPackage.MERONYMIC__IS_IMMUTABLE_PART, oldIsImmutablePart, isImmutablePart));
	}
	...
	public void setIsImmutableWhole(boolean newIsImmutableWhole) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UMLPlusPackage.MERONYMIC__IS_IMMUTABLE_WHOLE, oldIsImmutableWhole, isImmutableWhole));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case UMLPlusPackage.MERONYMIC__IS_SHAREABLE:
				return isIsShareable() ? Boolean.TRUE : Boolean.FALSE;
			case UMLPlusPackage.MERONYMIC__IS_ESSENTIAL:
				return isIsEssential() ? Boolean.TRUE : Boolean.FALSE;
			case UMLPlusPackage.MERONYMIC__IS_INSEPARABLE:
				return isIsInseparable() ? Boolean.TRUE : Boolean.FALSE;
			case UMLPlusPackage.MERONYMIC__IS_IMMUTABLE_PART:
				return isIsImmutablePart() ? Boolean.TRUE : Boolean.FALSE;
			case UMLPlusPackage.MERONYMIC__IS_IMMUTABLE_WHOLE:
	...
	public String toString() {
		...
		result.append(" (isShareable: "); //$NON-NLS-1$
		result.append(isShareable);
		result.append(", isEssential: "); //$NON-NLS-1$
		result.append(isEssential);
		result.append(", isInseparable: "); //$NON-NLS-1$
		result.append(isInseparable);
		result.append(", isImmutablePart: "); //$NON-NLS-1$
		result.append(isImmutablePart);
		result.append(", isImmutableWhole: "); //$NON-NLS-1$
