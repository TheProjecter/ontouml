...
public class CollectiveEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
					...
					public Command getCommand(Request request) {
						if (understandsRequest(request)) {
							if (request instanceof CreateViewAndElementRequest) {
								...
								if (type == UMLPlus.diagram.providers.UMLPlusElementTypes.Property_2002) {
									EditPart compartmentEditPart = getChildBySemanticHint(UMLPlus.diagram.part.UMLPlusVisualIDRegistry
											.getType(UMLPlus.diagram.edit.parts.CollectiveAttributeCompartmentEditPart.VISUAL_ID));
		...
		installEditPolicy(
				...
				new UMLPlus.diagram.edit.policies.CollectiveItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof UMLPlus.diagram.edit.parts.WrapLabel2EditPart) {
			((UMLPlus.diagram.edit.parts.WrapLabel2EditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureCollectiveLabelFigure());
			return true;
		}
		if (childEditPart instanceof UMLPlus.diagram.edit.parts.CollectiveNameEditPart) {
			((UMLPlus.diagram.edit.parts.CollectiveNameEditPart) childEditPart)
					.setLabel(getPrimaryShape()
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UMLPlus.diagram.part.UMLPlusVisualIDRegistry
				.getType(UMLPlus.diagram.edit.parts.WrapLabel2EditPart.VISUAL_ID));
	}
	...
	public class CollectiveFigure extends RectangleFigure {
		 ...
		 * @generated
		 */
		private WrapLabel fFigureCollectiveLabelFigure;
		/**
		 * @generated
		 */
		private WrapLabel fFigureCollectiveNameLabelFigure;
		/**
		 * @generated
		 */
		private WrapLabel fFigureCollectiveMetaAttributeLabelFigure;
		 ...
		 * @generated
		 */
		public WrapLabel getFigureCollectiveLabelFigure() {
		 ...
		 * @generated
		 */
		public WrapLabel getFigureCollectiveNameLabelFigure() {
		 ...
		 * @generated
		 */
		public WrapLabel getFigureCollectiveMetaAttributeLabelFigure() {
