...
public class SubQuantityOfCustomFigure extends PolylineDecoration {
...
public SubQuantityOfCustomFigure(SubQuantityOfEditPart subquantityofeditpart) {
this.subquantityofeditpart = subquantityofeditpart; 	
}

/** Associa a decoração correta, dependendo do atributo isShareable. */
protected boolean updateFace() {
	subQuantityOf s = (subQuantityOf)((View)subquantityofeditpart.getModel()).getElement();
