...
public class SimpleDatatypeEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
					...
					public Command getCommand(Request request) {
						if (understandsRequest(request)) {
							if (request instanceof CreateViewAndElementRequest) {
								...
								if (type == UMLPlus.diagram.providers.UMLPlusElementTypes.Property_2011) {
									EditPart compartmentEditPart = getChildBySemanticHint(UMLPlus.diagram.part.UMLPlusVisualIDRegistry
											.getType(UMLPlus.diagram.edit.parts.SimpleDatatypeAttributeCompartmentEditPart.VISUAL_ID));
		...
		installEditPolicy(
				...
				new UMLPlus.diagram.edit.policies.SimpleDatatypeItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof UMLPlus.diagram.edit.parts.WrapLabel11EditPart) {
			((UMLPlus.diagram.edit.parts.WrapLabel11EditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureSimpleDatatypeLabelFigure());
			return true;
		}
		if (childEditPart instanceof UMLPlus.diagram.edit.parts.SimpleDatatypeNameEditPart) {
			((UMLPlus.diagram.edit.parts.SimpleDatatypeNameEditPart) childEditPart)
					.setLabel(getPrimaryShape()
	...
	public class SimpleDatatypeFigure extends RectangleFigure {
		 ...
		 * @generated
		 */
		private WrapLabel fFigureSimpleDatatypeLabelFigure;
		/**
		 * @generated
		 */
		private WrapLabel fFigureSimpleDatatypeNameLabelFigure;
		...
		private void createContents() {
			...
			fFigureSimpleDatatypeLabelFigure = new WrapLabel();
			fFigureSimpleDatatypeLabelFigure.setText("<<SimpleDatatype>>");

			this.add(fFigureSimpleDatatypeLabelFigure);

			fFigureSimpleDatatypeNameLabelFigure = new WrapLabel();
		...
		//Criei para atualizar a exibição dos meta-atributos
		private void updateContents(SimpleDatatypeEditPart simpledatatypeeditpart) {
			
			SimpleDatatype s = (SimpleDatatype)((View)simpledatatypeeditpart.getModel()).getElement();
		 ...
		 * @generated
		 */
		public WrapLabel getFigureSimpleDatatypeLabelFigure() {
		 ...
		 * @generated
		 */
		public WrapLabel getFigureSimpleDatatypeNameLabelFigure() {
