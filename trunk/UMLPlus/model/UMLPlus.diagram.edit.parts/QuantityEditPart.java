...
public class QuantityEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
					...
					public Command getCommand(Request request) {
						if (understandsRequest(request)) {
							if (request instanceof CreateViewAndElementRequest) {
								...
								if (type == UMLPlus.diagram.providers.UMLPlusElementTypes.Property_2007) {
									EditPart compartmentEditPart = getChildBySemanticHint(UMLPlus.diagram.part.UMLPlusVisualIDRegistry
											.getType(UMLPlus.diagram.edit.parts.QuantityAttributeCompartmentEditPart.VISUAL_ID));
		...
		installEditPolicy(
				...
				new UMLPlus.diagram.edit.policies.QuantityItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof UMLPlus.diagram.edit.parts.WrapLabel7EditPart) {
			((UMLPlus.diagram.edit.parts.WrapLabel7EditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureQuantityLabelFigure());
			return true;
		}
		if (childEditPart instanceof UMLPlus.diagram.edit.parts.QuantityNameEditPart) {
			((UMLPlus.diagram.edit.parts.QuantityNameEditPart) childEditPart)
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UMLPlus.diagram.part.UMLPlusVisualIDRegistry
				.getType(UMLPlus.diagram.edit.parts.WrapLabel7EditPart.VISUAL_ID));
	}
	...
	public class QuantityFigure extends RectangleFigure {
		 ...
		 * @generated
		 */
		private WrapLabel fFigureQuantityLabelFigure;
		/**
		 * @generated
		 */
		private WrapLabel fFigureQuantityNameLabelFigure;
		...
		private void createContents() {
			...
			fFigureQuantityLabelFigure = new WrapLabel();
			fFigureQuantityLabelFigure.setText("<<quantity>>");

			this.add(fFigureQuantityLabelFigure);

			fFigureQuantityNameLabelFigure = new WrapLabel();
		 ...
		 * @generated
		 */
		public WrapLabel getFigureQuantityLabelFigure() {
		 ...
		 * @generated
		 */
		public WrapLabel getFigureQuantityNameLabelFigure() {
