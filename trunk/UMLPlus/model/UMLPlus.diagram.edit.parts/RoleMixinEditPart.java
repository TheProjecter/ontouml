...
public class RoleMixinEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
					...
					public Command getCommand(Request request) {
						if (understandsRequest(request)) {
							if (request instanceof CreateViewAndElementRequest) {
								...
								if (type == UMLPlus.diagram.providers.UMLPlusElementTypes.Property_2010) {
									EditPart compartmentEditPart = getChildBySemanticHint(UMLPlus.diagram.part.UMLPlusVisualIDRegistry
											.getType(UMLPlus.diagram.edit.parts.RoleMixinAttributeCompartmentEditPart.VISUAL_ID));
		...
		installEditPolicy(
				...
				new UMLPlus.diagram.edit.policies.RoleMixinItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof UMLPlus.diagram.edit.parts.WrapLabel10EditPart) {
			((UMLPlus.diagram.edit.parts.WrapLabel10EditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureRoleMixinLabelFigure());
			return true;
		}
		if (childEditPart instanceof UMLPlus.diagram.edit.parts.RoleMixinNameEditPart) {
			((UMLPlus.diagram.edit.parts.RoleMixinNameEditPart) childEditPart)
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UMLPlus.diagram.part.UMLPlusVisualIDRegistry
				.getType(UMLPlus.diagram.edit.parts.WrapLabel10EditPart.VISUAL_ID));
	}
	...
	public class RoleMixinFigure extends RectangleFigure {
		 ...
		 * @generated
		 */
		private WrapLabel fFigureRoleMixinLabelFigure;
		/**
		 * @generated
		 */
		private WrapLabel fFigureRoleMixinNameLabelFigure;
		...
		private void createContents() {
			...
			fFigureRoleMixinLabelFigure = new WrapLabel();
			fFigureRoleMixinLabelFigure.setText("<<roleMixin>>");

			this.add(fFigureRoleMixinLabelFigure);

			fFigureRoleMixinNameLabelFigure = new WrapLabel();
		 ...
		 * @generated
		 */
		public WrapLabel getFigureRoleMixinLabelFigure() {
		 ...
		 * @generated
		 */
		public WrapLabel getFigureRoleMixinNameLabelFigure() {
