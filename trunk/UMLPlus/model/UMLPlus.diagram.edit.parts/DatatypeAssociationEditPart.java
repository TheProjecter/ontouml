...
public class DatatypeAssociationEditPart extends ConnectionNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new UMLPlus.diagram.edit.policies.DatatypeAssociationItemSemanticEditPolicy());
	}
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof UMLPlus.diagram.edit.parts.DatatypeAssociationNameEditPart) {
			((UMLPlus.diagram.edit.parts.DatatypeAssociationNameEditPart) childEditPart)
	...
	public class DatatypeAssociationFigure extends PolylineConnectionEx {
		 ...
		 * @generated
		 */
		private WrapLabel fFigureDatatypeAssociationNameLabelFigure;
		...
		private void createContents(DatatypeAssociationEditPart datatypeassociationeditpart) {
			...
			fFigureDatatypeAssociationNameLabelFigure = new WrapLabel();
		 ...
		 * @generated
		 */
		public WrapLabel getFigureDatatypeAssociationNameLabelFigure() {
