...
public class RelatorEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
					...
					public Command getCommand(Request request) {
						if (understandsRequest(request)) {
							if (request instanceof CreateViewAndElementRequest) {
								...
								if (type == UMLPlus.diagram.providers.UMLPlusElementTypes.Property_2008) {
									EditPart compartmentEditPart = getChildBySemanticHint(UMLPlus.diagram.part.UMLPlusVisualIDRegistry
											.getType(UMLPlus.diagram.edit.parts.RelatorAttributeCompartmentEditPart.VISUAL_ID));
		...
		installEditPolicy(
				...
				new UMLPlus.diagram.edit.policies.RelatorItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof UMLPlus.diagram.edit.parts.WrapLabel8EditPart) {
			((UMLPlus.diagram.edit.parts.WrapLabel8EditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureRelatorLabelFigure());
			return true;
		}
		if (childEditPart instanceof UMLPlus.diagram.edit.parts.RelatorNameEditPart) {
			((UMLPlus.diagram.edit.parts.RelatorNameEditPart) childEditPart)
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UMLPlus.diagram.part.UMLPlusVisualIDRegistry
				.getType(UMLPlus.diagram.edit.parts.WrapLabel8EditPart.VISUAL_ID));
	}
	...
	public class RelatorFigure extends RectangleFigure {
		 ...
		 * @generated
		 */
		private WrapLabel fFigureRelatorLabelFigure;
		/**
		 * @generated
		 */
		private WrapLabel fFigureRelatorNameLabelFigure;
		...
		private void createContents() {
			...
			fFigureRelatorLabelFigure = new WrapLabel();
			fFigureRelatorLabelFigure.setText("<<relator>>");

			this.add(fFigureRelatorLabelFigure);

			fFigureRelatorNameLabelFigure = new WrapLabel();
		 ...
		 * @generated
		 */
		public WrapLabel getFigureRelatorLabelFigure() {
		 ...
		 * @generated
		 */
		public WrapLabel getFigureRelatorNameLabelFigure() {
