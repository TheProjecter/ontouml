...
public class CategoryEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
					...
					public Command getCommand(Request request) {
						if (understandsRequest(request)) {
							if (request instanceof CreateViewAndElementRequest) {
								...
								if (type == UMLPlus.diagram.providers.UMLPlusElementTypes.Property_2001) {
									EditPart compartmentEditPart = getChildBySemanticHint(UMLPlus.diagram.part.UMLPlusVisualIDRegistry
											.getType(UMLPlus.diagram.edit.parts.CategoryAttributeCompartmentEditPart.VISUAL_ID));
		...
		installEditPolicy(
				...
				new UMLPlus.diagram.edit.policies.CategoryItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof UMLPlus.diagram.edit.parts.WrapLabelEditPart) {
			((UMLPlus.diagram.edit.parts.WrapLabelEditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureCategoryLabelFigure());
			return true;
		}
		if (childEditPart instanceof UMLPlus.diagram.edit.parts.CategoryNameEditPart) {
			((UMLPlus.diagram.edit.parts.CategoryNameEditPart) childEditPart)
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UMLPlus.diagram.part.UMLPlusVisualIDRegistry
				.getType(UMLPlus.diagram.edit.parts.WrapLabelEditPart.VISUAL_ID));
	}
	...
	public class CategoryFigure extends RectangleFigure {
		 ...
		 * @generated
		 */
		private WrapLabel fFigureCategoryLabelFigure;
		/**
		 * @generated
		 */
		private WrapLabel fFigureCategoryNameLabelFigure;
		...
		private void createContents() {
			...
			fFigureCategoryLabelFigure = new WrapLabel();
			fFigureCategoryLabelFigure.setText("<<category>>");

			this.add(fFigureCategoryLabelFigure);

			fFigureCategoryNameLabelFigure = new WrapLabel();
		 ...
		 * @generated
		 */
		public WrapLabel getFigureCategoryLabelFigure() {
		 ...
		 * @generated
		 */
		public WrapLabel getFigureCategoryNameLabelFigure() {
