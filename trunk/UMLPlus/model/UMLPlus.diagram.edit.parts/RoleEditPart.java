...
public class RoleEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
					...
					public Command getCommand(Request request) {
						if (understandsRequest(request)) {
							if (request instanceof CreateViewAndElementRequest) {
								...
								if (type == UMLPlus.diagram.providers.UMLPlusElementTypes.Property_2009) {
									EditPart compartmentEditPart = getChildBySemanticHint(UMLPlus.diagram.part.UMLPlusVisualIDRegistry
											.getType(UMLPlus.diagram.edit.parts.RoleAttributeCompartmentEditPart.VISUAL_ID));
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new UMLPlus.diagram.edit.policies.RoleItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof UMLPlus.diagram.edit.parts.WrapLabel9EditPart) {
			((UMLPlus.diagram.edit.parts.WrapLabel9EditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureRoleLabelFigure());
			return true;
		}
		if (childEditPart instanceof UMLPlus.diagram.edit.parts.RoleNameEditPart) {
			((UMLPlus.diagram.edit.parts.RoleNameEditPart) childEditPart)
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UMLPlus.diagram.part.UMLPlusVisualIDRegistry
				.getType(UMLPlus.diagram.edit.parts.WrapLabel9EditPart.VISUAL_ID));
	}
	...
	public class RoleFigure extends RectangleFigure {
		 ...
		 * @generated
		 */
		private WrapLabel fFigureRoleLabelFigure;
		/**
		 * @generated
		 */
		private WrapLabel fFigureRoleNameLabelFigure;
		...
		private void createContents() {
			...
			fFigureRoleLabelFigure = new WrapLabel();
			fFigureRoleLabelFigure.setText("<<role>>");

			this.add(fFigureRoleLabelFigure);

			fFigureRoleNameLabelFigure = new WrapLabel();
		 ...
		 * @generated
		 */
		public WrapLabel getFigureRoleLabelFigure() {
		 ...
		 * @generated
		 */
		public WrapLabel getFigureRoleNameLabelFigure() {
