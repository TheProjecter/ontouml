...
public class MemberOfEditPart extends ConnectionNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new UMLPlus.diagram.edit.policies.MemberOfItemSemanticEditPolicy());
	}
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof UMLPlus.diagram.edit.parts.MemberOfNameEditPart) {
			((UMLPlus.diagram.edit.parts.MemberOfNameEditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureMemberOfNameLabelFigure());
			return true;
		}
		if (childEditPart instanceof UMLPlus.diagram.edit.parts.WrapLabel23EditPart) {
			((UMLPlus.diagram.edit.parts.WrapLabel23EditPart) childEditPart)
					.setLabel(getPrimaryShape()
	...
	public class MemberOfFigure extends PolylineConnectionEx {
		 ...
		 * @generated
		 */
		private WrapLabel fFigureMemberOfNameLabelFigure;
		/**
		 * @generated
		 */
		private WrapLabel fFigureMemberOfMetaAttributesLabelFigure;
		...
		private void createContents(MemberOfEditPart memberofeditpart) {
			...
			fFigureMemberOfNameLabelFigure = new WrapLabel();
			fFigureMemberOfNameLabelFigure.setText("Name");
			
			this.add(fFigureMemberOfNameLabelFigure);

			fFigureMemberOfMetaAttributesLabelFigure = new WrapLabel();
		...
		private RotatableDecoration createSourceDecoration() {
			UMLPlus.diagram.edit.parts.MemberOfCustomFigure df = new UMLPlus.diagram.edit.parts.MemberOfCustomFigure(MemberOfEditPart.this);
		 ...
		 * @generated
		 */
		public WrapLabel getFigureMemberOfNameLabelFigure() {
		 ...
		 * @generated
		 */
		public WrapLabel getFigureMemberOfMetaAttributesLabelFigure() {
