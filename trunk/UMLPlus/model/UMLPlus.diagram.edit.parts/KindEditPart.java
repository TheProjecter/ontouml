...
public class KindEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
					...
					public Command getCommand(Request request) {
						if (understandsRequest(request)) {
							if (request instanceof CreateViewAndElementRequest) {
								...
								if (type == UMLPlus.diagram.providers.UMLPlusElementTypes.Property_2003) {
									EditPart compartmentEditPart = getChildBySemanticHint(UMLPlus.diagram.part.UMLPlusVisualIDRegistry
											.getType(UMLPlus.diagram.edit.parts.KindAttributeCompartmentEditPart.VISUAL_ID));
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new UMLPlus.diagram.edit.policies.KindItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof UMLPlus.diagram.edit.parts.WrapLabel3EditPart) {
			((UMLPlus.diagram.edit.parts.WrapLabel3EditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureKindLabelFigure());
			return true;
		}
		if (childEditPart instanceof UMLPlus.diagram.edit.parts.KindNameEditPart) {
			((UMLPlus.diagram.edit.parts.KindNameEditPart) childEditPart)
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UMLPlus.diagram.part.UMLPlusVisualIDRegistry
				.getType(UMLPlus.diagram.edit.parts.WrapLabel3EditPart.VISUAL_ID));
	}
	...
	public class KindFigure extends RectangleFigure {
		 ...
		 * @generated
		 */
		private WrapLabel fFigureKindLabelFigure;
		/**
		 * @generated
		 */
		private WrapLabel fFigureKindNameLabelFigure;
		...
		private void createContents() {
			...
			fFigureKindLabelFigure = new WrapLabel();
			fFigureKindLabelFigure.setText("<<kind>>");

			this.add(fFigureKindLabelFigure);

			fFigureKindNameLabelFigure = new WrapLabel();
		 ...
		 * @generated
		 */
		public WrapLabel getFigureKindLabelFigure() {
		 ...
		 * @generated
		 */
		public WrapLabel getFigureKindNameLabelFigure() {
