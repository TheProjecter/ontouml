...
public class GeneralizationEditPart extends ConnectionNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new UMLPlus.diagram.edit.policies.GeneralizationItemSemanticEditPolicy());
	}
	...
	public class GeneralizationFigure extends PolylineConnectionEx {
		...
		private RotatableDecoration createTargetDecoration() {
			UMLPlus.diagram.edit.parts.GeneralizationCustomFigure df = new UMLPlus.diagram.edit.parts.GeneralizationCustomFigure();
