...
public class SubQuantityOfEditPart extends ConnectionNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new UMLPlus.diagram.edit.policies.SubQuantityOfItemSemanticEditPolicy());
	}
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof UMLPlus.diagram.edit.parts.SubQuantityOfNameEditPart) {
			((UMLPlus.diagram.edit.parts.SubQuantityOfNameEditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureSubQuantityOfNameLabelFigure());
			return true;
		}
		if (childEditPart instanceof UMLPlus.diagram.edit.parts.WrapLabel25EditPart) {
			((UMLPlus.diagram.edit.parts.WrapLabel25EditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureSubQuantityOfMetaAttributesLabelFigure());
			return true;
		}
		if (childEditPart instanceof UMLPlus.diagram.edit.parts.WrapLabel26EditPart) {
			((UMLPlus.diagram.edit.parts.WrapLabel26EditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureSubQuantityOfSourceCardinalityLabelFigure());
			return true;
		}
		if (childEditPart instanceof UMLPlus.diagram.edit.parts.WrapLabel27EditPart) {
			((UMLPlus.diagram.edit.parts.WrapLabel27EditPart) childEditPart)
					.setLabel(getPrimaryShape()
	...
	public class SubQuantityOfFigure extends PolylineConnectionEx {
		 ...
		 * @generated
		 */
		private WrapLabel fFigureSubQuantityOfNameLabelFigure;
		/**
		 * @generated
		 */
		private WrapLabel fFigureSubQuantityOfMetaAttributesLabelFigure;
		/**
		 * @generated
		 */
		private WrapLabel fFigureSubQuantityOfSourceCardinalityLabelFigure;
		/**
		 * @generated
		 */
		private WrapLabel fFigureSubQuantityOfTargetCardinalityLabelFigure;
		...
		private void createContents(SubQuantityOfEditPart subquantityofeditpart) {
			...
			fFigureSubQuantityOfNameLabelFigure = new WrapLabel();
			fFigureSubQuantityOfNameLabelFigure.setText("Name");
			
			this.add(fFigureSubQuantityOfNameLabelFigure);

			fFigureSubQuantityOfMetaAttributesLabelFigure = new WrapLabel();
			...
			fFigureSubQuantityOfSourceCardinalityLabelFigure = new WrapLabel();
			text = "";
			...
			fFigureSubQuantityOfTargetCardinalityLabelFigure = new WrapLabel();
			text = "";
		...
		private RotatableDecoration createSourceDecoration() {
			UMLPlus.diagram.edit.parts.SubQuantityOfCustomFigure df = new UMLPlus.diagram.edit.parts.SubQuantityOfCustomFigure(SubQuantityOfEditPart.this);
		 ...
		 * @generated
		 */
		public WrapLabel getFigureSubQuantityOfNameLabelFigure() {
		 ...
		 * @generated
		 */
		public WrapLabel getFigureSubQuantityOfMetaAttributesLabelFigure() {
		 ...
		 * @generated
		 */
		public WrapLabel getFigureSubQuantityOfSourceCardinalityLabelFigure() {
		 ...
		 * @generated
		 */
		public WrapLabel getFigureSubQuantityOfTargetCardinalityLabelFigure() {
