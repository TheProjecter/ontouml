...
public class OntoUMLBaseItemSemanticEditPolicy extends SemanticEditPolicy {
	...
	public static class LinkConstraints {
		 ...
		 * @generated
		 */
		public static boolean canCreateDatatypeRelationship_4019(
				OntoUML.Container container, OntoUML.Element source,
				OntoUML.Element target) {
			return canExistDatatypeRelationship_4019(container, source, target);
		}
		...
		public static boolean canCreateBinaryAssociationAtom_4015(
				...
				OntoUML.URML.DerivationRule source, OntoUML.Relationship target) {
		 ...
		 * @generated
		 */
		public static boolean canExistDatatypeRelationship_4019(
				OntoUML.Container container, OntoUML.Element source,
				OntoUML.Element target) {
