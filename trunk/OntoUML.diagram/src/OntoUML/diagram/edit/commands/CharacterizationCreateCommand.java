 ...
 * @generated
 */
public class CharacterizationCreateCommand extends CreateElementCommand {
	 ...
	 * @generated
	 */
	public CharacterizationCreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		return OntoUML.diagram.edit.policies.OntoUMLBaseItemSemanticEditPolicy.LinkConstraints
				.canCreateCharacterization_4001(getContainer(), getSource(),
						getTarget());
	}
	...
	protected EObject doDefaultElementCreation() {
		OntoUML.Characterization newElement = OntoUML.OntoUMLFactory.eINSTANCE
		...
		OntoUML.diagram.providers.OntoUMLElementTypes
				.init_Characterization_4001(newElement);
		return newElement;
	}
