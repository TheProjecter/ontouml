 ...
 * @generated
 */
public class DatatypeRelationshipReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public DatatypeRelationshipReorientCommand(
	...
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof OntoUML.DatatypeRelationship) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		...
		return OntoUML.diagram.edit.policies.OntoUMLBaseItemSemanticEditPolicy.LinkConstraints
				.canExistDatatypeRelationship_4019(container, getNewSource(),
						target);
	}
	...
	protected boolean canReorientTarget() {
		...
		OntoUML.Container container = (OntoUML.Container) getLink()
				.eContainer();
		return OntoUML.diagram.edit.policies.OntoUMLBaseItemSemanticEditPolicy.LinkConstraints
				.canExistDatatypeRelationship_4019(container, source,
						getNewTarget());
	}
	 ...
	 * @generated
	 */
	protected OntoUML.DatatypeRelationship getLink() {
		return (OntoUML.DatatypeRelationship) getElementToEdit();
	}
