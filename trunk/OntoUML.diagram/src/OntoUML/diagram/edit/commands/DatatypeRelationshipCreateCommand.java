 ...
 * @generated
 */
public class DatatypeRelationshipCreateCommand extends CreateElementCommand {
	 ...
	 * @generated
	 */
	public DatatypeRelationshipCreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		return OntoUML.diagram.edit.policies.OntoUMLBaseItemSemanticEditPolicy.LinkConstraints
				.canCreateDatatypeRelationship_4019(getContainer(),
						getSource(), getTarget());
	}
	...
	protected EObject doDefaultElementCreation() {
		OntoUML.DatatypeRelationship newElement = OntoUML.OntoUMLFactory.eINSTANCE
				.createDatatypeRelationship();
		...
		OntoUML.diagram.providers.OntoUMLElementTypes
				.init_DatatypeRelationship_4019(newElement);
		return newElement;
	}
