 ...
 * @generated
 */
public class DatatypeAssociationCreateCommand extends CreateElementCommand {
	 ...
	 * @generated
	 */
	public DatatypeAssociationCreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		return OntoUML.diagram.edit.policies.OntoUMLBaseItemSemanticEditPolicy.LinkConstraints
				.canCreateDatatypeAssociation_4003(getContainer(), getSource(),
						getTarget());
	}
	...
	protected EObject doDefaultElementCreation() {
		OntoUML.DatatypeAssociation newElement = OntoUML.OntoUMLFactory.eINSTANCE
		...
		OntoUML.diagram.providers.OntoUMLElementTypes
				.init_DatatypeAssociation_4003(newElement);
		return newElement;
	}
