 ...
 * @generated
 */
public class MaterialAssociationReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public MaterialAssociationReorientCommand(
	...
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof OntoUML.MaterialAssociation) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		...
		return OntoUML.diagram.edit.policies.OntoUMLBaseItemSemanticEditPolicy.LinkConstraints
				.canExistMaterialAssociation_4007(container, getNewSource(),
						target);
	}
	...
	protected boolean canReorientTarget() {
		...
		OntoUML.Container container = (OntoUML.Container) getLink()
				.eContainer();
		return OntoUML.diagram.edit.policies.OntoUMLBaseItemSemanticEditPolicy.LinkConstraints
				.canExistMaterialAssociation_4007(container, source,
						getNewTarget());
	}
	 ...
	 * @generated
	 */
	protected OntoUML.MaterialAssociation getLink() {
		return (OntoUML.MaterialAssociation) getElementToEdit();
	}
