 ...
 * @generated
 */
public class MediationCreateCommand extends CreateElementCommand {
	 ...
	 * @generated
	 */
	public MediationCreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		return OntoUML.diagram.edit.policies.OntoUMLBaseItemSemanticEditPolicy.LinkConstraints
				.canCreateMediation_4008(getContainer(), getSource(),
						getTarget());
	}
	...
	protected EObject doDefaultElementCreation() {
		OntoUML.Mediation newElement = OntoUML.OntoUMLFactory.eINSTANCE
				.createMediation();
		...
		OntoUML.diagram.providers.OntoUMLElementTypes
				.init_Mediation_4008(newElement);
		return newElement;
	}
