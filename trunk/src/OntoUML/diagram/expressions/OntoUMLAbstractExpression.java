 ...
 * @generated
 */
public abstract class OntoUMLAbstractExpression {
	...
	protected void setStatus(int severity, String message, Throwable throwable) {
		String pluginID = OntoUML.diagram.part.OntoUMLDiagramEditorPlugin.ID;
	 ...
	 * @generated
	 */
	protected OntoUMLAbstractExpression(String body, EClassifier context) {
		myBody = body;
		myContext = context;
	}
