...
public class OntoUMLPaletteFactory {
	...
	public void fillPalette(PaletteRoot paletteRoot) {
		...
		paletteRoot.add(createOntoUMLRelations2Group());
		paletteRoot.add(createRules3Group());
	}
	...
	private PaletteContainer createOntoUMLClasses1Group() {
		...
		paletteContainer.add(createAttribute15CreationTool());
		return paletteContainer;
	}

	/**
	 * Creates "OntoUML Relations" palette tool group
	 * @generated
	 */
	private PaletteContainer createOntoUMLRelations2Group() {
		PaletteDrawer paletteContainer = new PaletteDrawer(
				OntoUML.diagram.part.Messages.OntoUMLRelations2Group_title);
		paletteContainer.add(createCharacterization1CreationTool());
		paletteContainer.add(createComponentOf2CreationTool());
		paletteContainer.add(createDatatypeAssociation3CreationTool());
	 ...
	 * @generated
	 */
	private PaletteContainer createRules3Group() {
		PaletteDrawer paletteContainer = new PaletteDrawer(
				OntoUML.diagram.part.Messages.Rules3Group_title);
		paletteContainer
				.setDescription(OntoUML.diagram.part.Messages.Rules3Group_desc);
	 ...
	 * @generated
	 */
	private ToolEntry createAttribute15CreationTool() {
		List/*<IElementType>*/types = new ArrayList/*<IElementType>*/(14);
		types.add(OntoUML.diagram.providers.OntoUMLElementTypes.Property_3001);
		types.add(OntoUML.diagram.providers.OntoUMLElementTypes.Property_3002);
		types.add(OntoUML.diagram.providers.OntoUMLElementTypes.Property_3003);
		types.add(OntoUML.diagram.providers.OntoUMLElementTypes.Property_3004);
		types.add(OntoUML.diagram.providers.OntoUMLElementTypes.Property_3005);
		types.add(OntoUML.diagram.providers.OntoUMLElementTypes.Property_3006);
		types.add(OntoUML.diagram.providers.OntoUMLElementTypes.Property_3007);
		types.add(OntoUML.diagram.providers.OntoUMLElementTypes.Property_3008);
		types.add(OntoUML.diagram.providers.OntoUMLElementTypes.Property_3009);
		types.add(OntoUML.diagram.providers.OntoUMLElementTypes.Property_3010);
		types.add(OntoUML.diagram.providers.OntoUMLElementTypes.Property_3011);
		types.add(OntoUML.diagram.providers.OntoUMLElementTypes.Property_3012);
		types.add(OntoUML.diagram.providers.OntoUMLElementTypes.Property_3013);
		types.add(OntoUML.diagram.providers.OntoUMLElementTypes.Property_3014);
		NodeToolEntry entry = new NodeToolEntry(
				OntoUML.diagram.part.Messages.Attribute15CreationTool_title,
				OntoUML.diagram.part.Messages.Attribute15CreationTool_desc,
				types);
		entry
				.setSmallIcon(OntoUML.diagram.providers.OntoUMLElementTypes
						.getImageDescriptor(OntoUML.diagram.providers.OntoUMLElementTypes.Property_3001));
		entry.setLargeIcon(entry.getSmallIcon());
		return entry;
	}
	 ...
	 * @generated
	 */
	private ToolEntry createDatatypeAssociation3CreationTool() {
		List/*<IElementType>*/types = new ArrayList/*<IElementType>*/(1);
		types
				.add(OntoUML.diagram.providers.OntoUMLElementTypes.DatatypeAssociation_4003);
		LinkToolEntry entry = new LinkToolEntry(
				OntoUML.diagram.part.Messages.DatatypeAssociation3CreationTool_title,
				OntoUML.diagram.part.Messages.DatatypeAssociation3CreationTool_desc,
				types);
		entry
				.setSmallIcon(OntoUML.diagram.providers.OntoUMLElementTypes
						.getImageDescriptor(OntoUML.diagram.providers.OntoUMLElementTypes.DatatypeAssociation_4003));
		entry.setLargeIcon(entry.getSmallIcon());
		return entry;
	}
	...
	private ToolEntry createCondition1CreationTool() {
		...
		types
				.add(OntoUML.diagram.providers.OntoUMLElementTypes.BinaryAssociationAtom_4014);
		types
				.add(OntoUML.diagram.providers.OntoUMLElementTypes.ClassifierAtom_4016);
		LinkToolEntry entry = new LinkToolEntry(
