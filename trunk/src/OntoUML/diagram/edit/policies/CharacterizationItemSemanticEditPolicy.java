 ...
 * @generated
 */
public class CharacterizationItemSemanticEditPolicy extends
	...
	protected Command getStartCreateRelationshipCommand(
		...
		if (OntoUML.diagram.providers.OntoUMLElementTypes.Property_4012 == req
				.getElementType()) {
			return null;
		}
		return null;
	...
	protected Command getCompleteCreateRelationshipCommand(
		...
		if (OntoUML.diagram.providers.OntoUMLElementTypes.Property_4012 == req
				.getElementType()) {
			return getGEFWrapper(new OntoUML.diagram.edit.commands.Property16CreateCommand(
					req, req.getSource(), req.getTarget()));
		}
		return null;
	}
	...
	protected Command getReorientRelationshipCommand(
		...
		case OntoUML.diagram.edit.parts.Property16EditPart.VISUAL_ID:
			return getGEFWrapper(new OntoUML.diagram.edit.commands.PropertyReorientCommand(
					req));
		}
