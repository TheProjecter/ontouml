 ...
 * @generated
 */
public class ClassifierAtom2CreateCommand extends CreateElementCommand {
	 ...
	 * @generated
	 */
	public ClassifierAtom2CreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		return OntoUML.diagram.edit.policies.OntoUMLBaseItemSemanticEditPolicy.LinkConstraints
				.canCreateClassifierAtom_4016(getContainer(), getSource(),
						getTarget());
	}
	...
	protected EObject doDefaultElementCreation() {
		...
		OntoUML.diagram.providers.OntoUMLElementTypes
				.init_ClassifierAtom_4016(newElement);
		return newElement;
	}
