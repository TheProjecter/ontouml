 ...
 * @generated
 */
public class DatatypeAssociationReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public DatatypeAssociationReorientCommand(
	...
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof OntoUML.DatatypeAssociation) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		...
		return OntoUML.diagram.edit.policies.OntoUMLBaseItemSemanticEditPolicy.LinkConstraints
				.canExistDatatypeAssociation_4003(container, getNewSource(),
						target);
	}
	...
	protected boolean canReorientTarget() {
		...
		OntoUML.Container container = (OntoUML.Container) getLink()
				.eContainer();
		return OntoUML.diagram.edit.policies.OntoUMLBaseItemSemanticEditPolicy.LinkConstraints
				.canExistDatatypeAssociation_4003(container, source,
						getNewTarget());
	}
	 ...
	 * @generated
	 */
	protected OntoUML.DatatypeAssociation getLink() {
		return (OntoUML.DatatypeAssociation) getElementToEdit();
	}
