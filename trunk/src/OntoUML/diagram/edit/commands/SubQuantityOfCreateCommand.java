 ...
 * @generated
 */
public class SubQuantityOfCreateCommand extends CreateElementCommand {
	 ...
	 * @generated
	 */
	public SubQuantityOfCreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		return OntoUML.diagram.edit.policies.OntoUMLBaseItemSemanticEditPolicy.LinkConstraints
				.canCreateSubQuantityOf_4011(getContainer(), getSource(),
						getTarget());
	}
	...
	protected EObject doDefaultElementCreation() {
		OntoUML.subQuantityOf newElement = OntoUML.OntoUMLFactory.eINSTANCE
				.createsubQuantityOf();
		...
		OntoUML.diagram.providers.OntoUMLElementTypes
				.init_SubQuantityOf_4011(newElement);
		return newElement;
	}
