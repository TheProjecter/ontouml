 ...
 * @generated
 */
public class DerivationCreateCommand extends CreateElementCommand {
	 ...
	 * @generated
	 */
	public DerivationCreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		return OntoUML.diagram.edit.policies.OntoUMLBaseItemSemanticEditPolicy.LinkConstraints
				.canCreateDerivation_4004(getContainer(), getSource(),
						getTarget());
	}
	...
	protected EObject doDefaultElementCreation() {
		OntoUML.Derivation newElement = OntoUML.OntoUMLFactory.eINSTANCE
				.createDerivation();
		...
		OntoUML.diagram.providers.OntoUMLElementTypes
				.init_Derivation_4004(newElement);
		return newElement;
	}
