 ...
 * @generated
 */
public class ClassifierAtomCreateCommand extends CreateElementCommand {
	 ...
	 * @generated
	 */
	public ClassifierAtomCreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		if (target != null && false == target instanceof OntoUML.Association) {
			return false;
		}
		if (getSource() == null) {
		...
		return OntoUML.diagram.edit.policies.OntoUMLBaseItemSemanticEditPolicy.LinkConstraints
				.canCreateBinaryAssociationAtom_4015(getContainer(),
						getSource(), getTarget());
	}
	 ...
	 * @generated
	 */
	protected OntoUML.Association getTarget() {
		return (OntoUML.Association) target;
	}
