...
public class PropertyEditPart extends ShapeNodeEditPart {
	...
	protected IFigure createNodeShape() {
		PropertyEndFigure figure = new PropertyEndFigure();
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof OntoUML.diagram.edit.parts.PropertyLowerUpper2EditPart) {
			((OntoUML.diagram.edit.parts.PropertyLowerUpper2EditPart) childEditPart)
					.setLabel(getPrimaryShape()
	...
	public class PropertyEndFigure extends RectangleFigure {
		...
		private void createContents() {
			...
			fFigurePropertyEndNameLabelFigure.setText("Name");
