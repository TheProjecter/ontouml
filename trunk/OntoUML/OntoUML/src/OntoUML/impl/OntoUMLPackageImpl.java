...
public class OntoUMLPackageImpl extends EPackageImpl implements OntoUMLPackage {
	 ...
	 * @generated
	 */
	public EReference getProperty_Aux() {
	...
	public void initializePackageContents() {
		...
		initEClass(datatypeAssociationEClass, DatatypeAssociation.class, "DatatypeAssociation", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		...
		initEReference(getElement_Attribute(), this.getElement(), this.getElement_Owner(), "attribute", null, 0, -1, Element.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getElement_Owner(), this.getElement(), this.getElement_Attribute(), "owner", null, 0, 1, Element.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getGeneralization_Semnome(), this.getGeneralizationSet(), this.getGeneralizationSet_Semnome(), "semnome", null, 0, -1, Generalization.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getGeneralizationSet_Semnome(), this.getGeneralization(), this.getGeneralization_Semnome(), "semnome", null, 0, -1, GeneralizationSet.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getMeronymic_IsEssential(), ecorePackage.getEBoolean(), "isEssential", "true", 0, 1, Meronymic.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getMeronymic_IsInseparable(), ecorePackage.getEBoolean(), "isInseparable", "true", 0, 1, Meronymic.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getMeronymic_IsImmutablePart(), ecorePackage.getEBoolean(), "isImmutablePart", "true", 0, 1, Meronymic.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getMeronymic_IsImmutableWhole(), ecorePackage.getEBoolean(), "isImmutableWhole", "true", 0, 1, Meronymic.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getMultiplicityElement_Upper(), ecorePackage.getEInt(), "upper", "0", 0, 1, MultiplicityElement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
