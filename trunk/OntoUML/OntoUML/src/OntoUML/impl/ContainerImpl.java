 ...
 * <ul>
 *   <li>{@link OntoUML.impl.ContainerImpl#getInstanciarElement <em>Instanciar Element</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ContainerImpl extends EObjectImpl implements Container {
	...
	public EList<Element> getInstanciarElement() {
		if (instanciarElement == null) {
			instanciarElement = new EObjectContainmentWithInverseEList<Element>(Element.class, this, OntoUMLPackage.CONTAINER__INSTANCIAR_ELEMENT, OntoUMLPackage.ELEMENT__CONTAINER);
		}
