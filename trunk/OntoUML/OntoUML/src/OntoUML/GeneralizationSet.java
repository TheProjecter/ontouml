 ...
 *   <li>{@link OntoUML.GeneralizationSet#getSemnome <em>Semnome</em>}</li>
 * </ul>
 * </p>
 *
...
public interface GeneralizationSet extends NamedElement {
	 ...
	 * It is bidirectional and its opposite is '{@link OntoUML.Generalization#getSemnome <em>Semnome</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see OntoUML.OntoUMLPackage#getGeneralizationSet_Semnome()
