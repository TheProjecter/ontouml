...
import OntoUML.impl.NamedElementImpl;
 ...
 * <ul>
 *   <li>{@link OntoUML.URML.impl.RuleImpl#getCondition <em>Condition</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class RuleImpl extends NamedElementImpl implements Rule {
	...
	protected EClass eStaticClass() {
		return URMLPackage.Literals.RULE;
	}
	...
	public EList<Condition> getCondition() {
		if (condition == null) {
			condition = new EObjectWithInverseResolvingEList<Condition>(Condition.class, this, URMLPackage.RULE__CONDITION, URMLPackage.CONDITION__CONDITION_RULE);
		}
		return condition;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case URMLPackage.RULE__CONDITION:
