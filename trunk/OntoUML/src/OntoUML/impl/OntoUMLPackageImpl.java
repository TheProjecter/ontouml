...
public class OntoUMLPackageImpl extends EPackageImpl implements OntoUMLPackage {
	...
	public void initializePackageContents() {
		...
		initEReference(getElement_Attribute(), this.getProperty(), this.getProperty_Owner(), "attribute", null, 0, -1, Element.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getProperty_Owner(), this.getElement(), this.getElement_Attribute(), "owner", null, 0, 1, Property.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
