 ...
 * @generated
 */
public class SubQuantityOfReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public SubQuantityOfReorientCommand(ReorientRelationshipRequest request) {
	...
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof OntoUML.subQuantityOf) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		...
		return OntoUML.diagram.edit.policies.OntoUMLBaseItemSemanticEditPolicy.LinkConstraints
				.canExistSubQuantityOf_4011(container, getNewSource(), target);
	}
	...
	protected boolean canReorientTarget() {
		...
		OntoUML.Container container = (OntoUML.Container) getLink()
				.eContainer();
		return OntoUML.diagram.edit.policies.OntoUMLBaseItemSemanticEditPolicy.LinkConstraints
				.canExistSubQuantityOf_4011(container, source, getNewTarget());
	}
	 ...
	 * @generated
	 */
	protected OntoUML.subQuantityOf getLink() {
		return (OntoUML.subQuantityOf) getElementToEdit();
	}
