 ...
 * @generated
 */
public class MixinCreateCommand extends CreateElementCommand {

	/**
	 * @generated
	 */
	public MixinCreateCommand(CreateElementRequest req) {
		super(req);
	}
	...
	protected EObject doDefaultElementCreation() {
		OntoUML.Mixin newElement = OntoUML.OntoUMLFactory.eINSTANCE
				.createMixin();
