 ...
 * @generated
 */
public class SubCollectionOfReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public SubCollectionOfReorientCommand(ReorientRelationshipRequest request) {
	...
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof OntoUML.subCollectionOf) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		...
		return OntoUML.diagram.edit.policies.OntoUMLBaseItemSemanticEditPolicy.LinkConstraints
				.canExistSubCollectionOf_4010(container, getNewSource(), target);
	}
	...
	protected boolean canReorientTarget() {
		...
		OntoUML.Container container = (OntoUML.Container) getLink()
				.eContainer();
		return OntoUML.diagram.edit.policies.OntoUMLBaseItemSemanticEditPolicy.LinkConstraints
				.canExistSubCollectionOf_4010(container, source, getNewTarget());
	}
	 ...
	 * @generated
	 */
	protected OntoUML.subCollectionOf getLink() {
		return (OntoUML.subCollectionOf) getElementToEdit();
	}
