 ...
 * @generated
 */
public class BinaryAssociationAtomName2EditPart extends LabelEditPart implements
		ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				OntoUML.diagram.part.OntoUMLVisualIDRegistry
						.getType(OntoUML.diagram.edit.parts.BinaryAssociationAtomName2EditPart.VISUAL_ID),
				new Point(0, 60));
	}
	 ...
	 * @generated
	 */
	public BinaryAssociationAtomName2EditPart(View view) {
		super(view);
	}
