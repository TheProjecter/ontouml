...
public class SimpleDatatypeEditPart extends ShapeNodeEditPart {
					...
					public Command getCommand(Request request) {
						if (understandsRequest(request)) {
							if (request instanceof CreateViewAndElementRequest) {
								...
								if (type == OntoUML.diagram.providers.OntoUMLElementTypes.Property_3011) {
	...
	public class SimpleDatatypeFigure extends RectangleFigure {
		...
		private void updateContents(
				SimpleDatatypeEditPart simpledatatypeeditpart) {

			SimpleDatatype s = (SimpleDatatype) ((View) simpledatatypeeditpart
					.getModel()).getElement();
