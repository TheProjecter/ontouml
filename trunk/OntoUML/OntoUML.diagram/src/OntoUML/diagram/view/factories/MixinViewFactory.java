 ...
 * @generated
 */
public class MixinViewFactory extends AbstractShapeViewFactory {
	...
	protected void decorateView(View containerView, View view,
		...
		if (semanticHint == null) {
			semanticHint = OntoUML.diagram.part.OntoUMLVisualIDRegistry
					.getType(OntoUML.diagram.edit.parts.MixinEditPart.VISUAL_ID);
		...
		getViewService()
				.createNode(
						...
						view,
						OntoUML.diagram.part.OntoUMLVisualIDRegistry
								.getType(OntoUML.diagram.edit.parts.MixinNameEditPart.VISUAL_ID),
						ViewUtil.APPEND, true, getPreferencesHint());
		getViewService()
				.createNode(
						eObjectAdapter,
