 ...
 * @generated
 */
public class StructuralDatatypeViewFactory extends AbstractShapeViewFactory {
	...
	protected void decorateView(View containerView, View view,
		...
		if (semanticHint == null) {
			semanticHint = OntoUML.diagram.part.OntoUMLVisualIDRegistry
					.getType(OntoUML.diagram.edit.parts.StructuralDatatypeEditPart.VISUAL_ID);
		...
		getViewService()
				.createNode(
						...
						view,
						OntoUML.diagram.part.OntoUMLVisualIDRegistry
								.getType(OntoUML.diagram.edit.parts.StructuralDatatypeNameEditPart.VISUAL_ID),
						ViewUtil.APPEND, true, getPreferencesHint());
		getViewService()
				.createNode(
						eObjectAdapter,
