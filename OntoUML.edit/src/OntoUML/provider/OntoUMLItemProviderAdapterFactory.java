...
public class OntoUMLItemProviderAdapterFactory extends OntoUMLAdapterFactory implements ComposeableAdapterFactory, IChangeNotifier, IDisposable {
	...
	/**
	 * This keeps track of the one adapter used for all {@link OntoUML.DatatypeAssociation} instances.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected DatatypeAssociationItemProvider datatypeAssociationItemProvider;

	/**
	 * This creates an adapter for a {@link OntoUML.DatatypeAssociation}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Adapter createDatatypeAssociationAdapter() {
		if (datatypeAssociationItemProvider == null) {
			datatypeAssociationItemProvider = new DatatypeAssociationItemProvider(this);
		}

		return datatypeAssociationItemProvider;
	}
	...
	public void dispose() {
		...
		if (datatypeAssociationItemProvider != null) datatypeAssociationItemProvider.dispose();
